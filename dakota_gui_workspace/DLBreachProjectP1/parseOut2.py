...
iterator = readdata('P1_cards.out')
...
avg_err = (abs(max_Flow - 2.979)/2.979 + abs(max_Time - 1560)/1560 + abs(max_Width - 6.46)/6.46 + abs(prc_Time - 840)/840 + abs(prc_Width_b - 1.28)/1.28 + abs(prc_Width_a - 1.28)/1.28)/6 * 100
