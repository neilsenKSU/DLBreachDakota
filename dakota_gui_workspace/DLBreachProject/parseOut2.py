...
avg_err = (abs(max_Flow - 3313)/3313 + abs(max_Time - 3300)/3300 + abs(max_Width - 96.15)/96.15 + abs(prc_Time - 600)/600 + abs(prc_Width_b - 0.46)/0.46 + abs(prc_Width_a - 10)/10.0)/6 * 100
